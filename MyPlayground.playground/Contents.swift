...
func smallest(inputOne: Double, inputTwo: Double) -> Double {
...
for (inputOne, inputTwo, expectedOutput) in testCasesTwo {
    let output = smallest(inputOne: inputOne, inputTwo: inputTwo)
...
func occurrances(inputOne: String, inputTwo: String) {
    if str in inputOne == Character(inputTwo) {
        return
    }
}
